...
1. Система отправляет данные о заказе в базу данных и отправляет СМС пользователю с информаций о том, что заказ подтвержден и примерным временем доставки заказа
